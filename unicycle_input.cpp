...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    if (nrhs != 36){ 
      mexErrMsgTxt("This problem expects 36 right hand side argument(s) since you have defined 36 MexInput(s)");
    } 
    ...
    ocp1.subjectTo((a*mexinput12+mexinput13*psi_dot-mexinput14) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((a*mexinput15+mexinput16*psi_dot-mexinput17) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((a*mexinput18+mexinput19*psi_dot-mexinput20) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((a*mexinput21+mexinput22*psi_dot-mexinput23) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((a*mexinput24+mexinput25*psi_dot-mexinput26) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((a*mexinput27+mexinput28*psi_dot-mexinput29) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((a*mexinput30+mexinput31*psi_dot-mexinput32) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((a*mexinput33+mexinput34*psi_dot-mexinput35) <= 0.00000000000000000000e+00);
