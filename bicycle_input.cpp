...
#include "bicycle_dynamics_L.cpp"
#include <mex.h>
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-1.00000000000000000000e+00) <= delta_f <= 1.00000000000000000000e+00);
    ...
    ocp1.subjectTo((-1.57600000000000006750e+00*psi_dot+yp_dot)/xp_dot <= 5.00000000000000000000e-01);
    ocp1.subjectTo((-1.26809517721534725787e+00+sqrt((pow((-(-1.54941590956547559088e+00)+ey),2.00000000000000000000e+00)+pow((-4.07050747364406859674e+01+s),2.00000000000000000000e+00)))) >= 0.00000000000000000000e+00);
    ocp1.subjectTo((-1.26809517721534725787e+00+sqrt((pow((-1.45222663682711461419e+00+ey),2.00000000000000000000e+00)+pow((-4.36263408528088021399e+01+s),2.00000000000000000000e+00)))) >= 0.00000000000000000000e+00);
    ocp1.subjectTo((-1.26809517721534725787e+00+sqrt((pow((-(-7.58303999233860714924e-01)+ey),2.00000000000000000000e+00)+pow((-4.66720722574927862070e+01+s),2.00000000000000000000e+00)))) >= 0.00000000000000000000e+00);
    ocp1.subjectTo((-1.26809517721534725787e+00+sqrt((pow((-(-1.86478362660943997042e+00)+ey),2.00000000000000000000e+00)+pow((-5.43337062128610526202e+01+s),2.00000000000000000000e+00)))) >= 0.00000000000000000000e+00);
    ocp1.subjectTo((-1.26809517721534725787e+00+sqrt((pow((-5.88936220982308853422e+01+s),2.00000000000000000000e+00)+pow((-6.12205566863783801068e-01+ey),2.00000000000000000000e+00)))) >= 0.00000000000000000000e+00);
